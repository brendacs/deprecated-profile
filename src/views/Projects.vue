<template>
  <div class="projects">
    ...
    <p>
      <a href="https://colludia.com" target="_blank">Colludia Indie Gaming Blog</a>. A game blog prioritizing niche indie games, while also shining light on the indie developers behind them all.
    </p>
    <p>
    ...
    <p>
      <a href="https://github.com/brendacs/referobot" target="_blank">Referobot</a>. A referral bot, created for referral-based Discord servers to easily count invites per member, top referrers, and number of members in the server.
    </p>
    <p>
      <a href="https://github.com/brendacs/devils-advocate" target="_blank">Devil's Advocate</a> (freelance). Weekly newsletter that sends political articles subscribers will disagree with in order to foster more open-minded dialog. Includes <a href="https://github.com/brendacs/devils-advocate-api">backend</a> for automatically categorizing subscribers based on quiz answers and assigning MailChimp tags.
    </p>
    <p>
    ...
    <p>
      <a href="https://github.com/brendacs/52in52/blob/master/log.md" target="_blank">52in52</a>. A challenge I made for myself to do 52 projects in 52 weeks a few years ago when I was first discovering frontend and the power of personal side projects in learning... I only did 4 weeks. Maybe I'll try this again sometime.
    </p>
  </div>
</template>
