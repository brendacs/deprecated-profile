<template>
  <div class="projects">
    ...
    <p>
      <a href="https://colludia.com" target="_blank">Colludia Gaming Blog</a>. A game blog prioritizing niche indie games, while also shining light on the indie developers behind them all.
    </p>
    <p>
